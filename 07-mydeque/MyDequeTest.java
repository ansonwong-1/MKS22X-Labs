...
public class MyDequeTest {
  ...
  public static void AddLast15() {
    ...
    System.out.println("asslast Correct: " + (real.toString().equals(test.toString())));
    System.out.println();
  }
  ...
  public static void AddFirst15() {
    ...
    System.out.println(test);
    System.out.println("addfirst Correct: " + (real.toString().equals(test.toString())));
    System.out.println();
  }
  ...
  public static void AddFirstLast15() {
    ...
    System.out.println(test);
    System.out.println("addfirst&lastCorrect: " + (real.toString().equals(test.toString())));
    System.out.println();
  }
  public static void AddRemove15() {
    ...
    System.out.println(test);
    System.out.println("addremovelastCorrect: " + (real.toString().equals(test.toString())));
    System.out.println();
  }
